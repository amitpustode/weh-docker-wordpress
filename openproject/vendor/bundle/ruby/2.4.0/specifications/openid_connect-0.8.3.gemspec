# -*- encoding: utf-8 -*-
# stub: openid_connect 0.8.3 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_runtime_dependency(%q<json-jwt>.freeze, [">= 0.5.5"])
      s.add_runtime_dependency(%q<swd>.freeze, [">= 0.1.2"])
      s.add_runtime_dependency(%q<webfinger>.freeze, [">= 0.0.2"])
      s.add_runtime_dependency(%q<rack-oauth2>.freeze, [">= 1.0.0"])
      ...
      s.add_dependency(%q<json-jwt>.freeze, [">= 0.5.5"])
      s.add_dependency(%q<swd>.freeze, [">= 0.1.2"])
      s.add_dependency(%q<webfinger>.freeze, [">= 0.0.2"])
      s.add_dependency(%q<rack-oauth2>.freeze, [">= 1.0.0"])
