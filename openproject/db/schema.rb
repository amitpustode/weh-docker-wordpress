...
ActiveRecord::Schema.define(version: 20170705134348) do
  ...
  create_table "cost_entries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id",                                                              null: false
    t.integer  "project_id",                                                           null: false
    t.integer  "work_package_id",                                                      null: false
    t.integer  "cost_type_id",                                                         null: false
    t.float    "units",            limit: 24,                                          null: false
  ...
  create_table "cost_object_journals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "journal_id",                null: false
    t.integer  "project_id",                null: false
  ...
  create_table "cost_objects", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "project_id",                null: false
    t.integer  "author_id",                 null: false
    t.string   "subject",                   null: false
    ...
    t.index ["project_id", "updated_on"], name: "index_cost_objects_on_project_id_and_updated_on", using: :btree
  end

  create_table "cost_queries", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "user_id",                                 null: false
  ...
  create_table "cost_types", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string   "name",                        null: false
  ...
  create_table "document_journals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "journal_id",                             null: false
    t.integer  "project_id",                default: 0,  null: false
  ...
  create_table "done_statuses_for_project", id: false, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "project_id"
    t.integer "status_id"
  end
  ...
  create_table "export_card_configurations", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string  "name"
    t.integer "per_page"
    t.string  "page_size"
    t.string  "orientation"
    t.text    "rows",        limit: 65535
  ...
  create_table "labor_budget_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
  ...
  create_table "material_budget_items", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer "cost_object_id",                                                  null: false
    t.float   "units",          limit: 24,                                       null: false
  ...
  create_table "my_projects_overviews", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "project_id",               default: 0, null: false
    t.text     "left",       limit: 65535,             null: false
    t.text     "right",      limit: 65535,             null: false
    t.text     "top",        limit: 65535,             null: false
  ...
  create_table "principal_roles", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "role_id",      null: false
    t.integer  "principal_id", null: false
    t.datetime "created_at"
    t.datetime "updated_at"
    t.index ["principal_id"], name: "index_principal_roles_on_principal_id", using: :btree
    t.index ["role_id"], name: "index_principal_roles_on_role_id", using: :btree
  end
  ...
  create_table "version_settings", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.integer  "project_id"
    t.integer  "version_id"
    t.integer  "display"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["project_id", "version_id"], name: "index_version_settings_on_project_id_and_version_id", using: :btree
  end
  ...
  create_table "work_package_journals", force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    ...
    t.float   "remaining_hours",  limit: 24
    t.index ["fixed_version_id", "status_id", "project_id", "type_id"], name: "work_package_journal_on_burndown_attributes", using: :btree
